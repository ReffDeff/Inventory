...
struct FItemAddResult
{
	...
	// Actual amount of item that was added
	UPROPERTY(BlueprintReadOnly, Category="Item Result")
	int32 ActualAmountAdded;

	// Enum representring the end state of an add item operation
	UPROPERTY(BlueprintReadOnly, Category="Item Result")
...
class CSS_API UInventoryComponent : public UActorComponent
{
	GENERATED_BODY()
